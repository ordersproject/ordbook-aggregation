...
//
//func FindOrderBrc20BidModelByOrderId(orderId string) (*model.OrderBrc20BidModel, error) {
//	collection, err :=  model.OrderBrc20BidModel{}.GetReadDB()
//	if err != nil {
//		return nil, err
//	}
//	queryBson := bson.D{
...
//		//{"state", model.STATE_EXIST},
//	}
//	entity := &model.OrderBrc20BidModel{}
//	err = collection.FindOne(context.TODO(), queryBson).Decode(entity)
//	if err != nil {
//		return nil, err
//	}
...
//
//
//func createOrderBrc20BidModel(orderBrc20Bid *model.OrderBrc20BidModel) (*model.OrderBrc20BidModel, error)  {
//	collection, err := model.OrderBrc20BidModel{}.GetWriteDB()
//	if err != nil {
//		return nil, err
//	}
//
...
//	entity := &model.OrderBrc20BidModel{
//		Id:             util.GetUUIDInt64(),
//		Net:        orderBrc20Bid.Net,
//		OrderId:        orderBrc20Bid.OrderId,
//		Tick:           orderBrc20Bid.Tick,
//		Amount:         orderBrc20Bid.Amount,
//		DecimalNum:     orderBrc20Bid.DecimalNum,
//		CoinAmount:     orderBrc20Bid.CoinAmount,
//		CoinDecimalNum: orderBrc20Bid.CoinDecimalNum,
//		CoinRatePrice:  orderBrc20Bid.CoinRatePrice,
//		OrderState:     orderBrc20Bid.OrderState,
//		OrderType:      orderBrc20Bid.OrderType,
//		SellerAddress:  orderBrc20Bid.SellerAddress,
//		BuyerAddress:   orderBrc20Bid.BuyerAddress,
//		PsbtRaw:        orderBrc20Bid.PsbtRaw,
//		Timestamp:      orderBrc20Bid.Timestamp,
//		CreateTime:     util.Time(),
//		State:          model.STATE_EXIST,
//	}
//
...
//}
//
//func SetOrderBrc20BidModel(orderBrc20Bid *model.OrderBrc20BidModel) (*model.OrderBrc20BidModel, error)  {
//	entity, err := FindOrderBrc20BidModelByOrderId(orderBrc20Bid.OrderId)
//	if err == nil && entity != nil {
//		collection, err := model.OrderBrc20BidModel{}.GetWriteDB()
//		if err != nil {
//			return nil, err
...
//		}
//		bsonData := bson.D{}
//		bsonData = append(bsonData, bson.E{Key: "net", Value: orderBrc20Bid.Net})
//		bsonData = append(bsonData, bson.E{Key: "orderId", Value: orderBrc20Bid.OrderId})
//		bsonData = append(bsonData, bson.E{Key: "tick", Value: orderBrc20Bid.Tick})
//		bsonData = append(bsonData, bson.E{Key: "amount", Value: orderBrc20Bid.Amount})
//		bsonData = append(bsonData, bson.E{Key: "decimalNum", Value: orderBrc20Bid.DecimalNum})
//		bsonData = append(bsonData, bson.E{Key: "coinAmount", Value: orderBrc20Bid.CoinAmount})
//		bsonData = append(bsonData, bson.E{Key: "coinDecimalNum", Value: orderBrc20Bid.CoinDecimalNum})
//		bsonData = append(bsonData, bson.E{Key: "coinRatePrice", Value: orderBrc20Bid.CoinRatePrice})
//		bsonData = append(bsonData, bson.E{Key: "orderState", Value: orderBrc20Bid.OrderState})
//		bsonData = append(bsonData, bson.E{Key: "orderType", Value: orderBrc20Bid.OrderType})
//		bsonData = append(bsonData, bson.E{Key: "sellerAddress", Value: orderBrc20Bid.SellerAddress})
//		bsonData = append(bsonData, bson.E{Key: "buyerAddress", Value: orderBrc20Bid.BuyerAddress})
//		bsonData = append(bsonData, bson.E{Key: "psbtRaw", Value: orderBrc20Bid.PsbtRaw})
//		bsonData = append(bsonData, bson.E{Key: "timestamp", Value: orderBrc20Bid.Timestamp})
//		bsonData = append(bsonData, bson.E{Key: "updateTime", Value: util.Time()})
...
//			return nil, err
//		}
//		return orderBrc20Bid, nil
//	} else {
//		return createOrderBrc20BidModel(orderBrc20Bid)
//	}
//}