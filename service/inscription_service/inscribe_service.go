...
//func InscribeMultiDataFromUtxoV2(netParams *chaincfg.Params, fromPriKeyHex, toAddress, content string, feeRate int64, changeAddress string, count int64, utxoList []*InscribeUtxo, outAddressType string, isOnlyCal bool, revealOutValue int64) (string, []string, []string, int64, error) {
//	//btcApiClient := mempool.NewClient(netParams)
//	btcApiClient := unisat.NewClient(netParams)
//	contentType := "text/plain;charset=utf-8"
//
...
//					return "", nil, nil, 0, err
//				}
//				//var addr btcutil.AddressSegWit
//				var pkScript []byte
//				if ord.UtxoAddressType(outAddressType) == ord.UtxoAddressTypeSegwit {
//					pkScript, err = txscript.PayToAddrScript(nativeSegwitAddress)
//					if err != nil {
//						return "", nil, nil, 0, err
//					}
//					//addr, err = btcutil.DecodeAddress(nativeSegwitAddress.EncodeAddress(), netParams)
...
//					//}
//				} else {
//					pkScript, err = txscript.PayToAddrScript(utxoTaprootAddress)
//					if err != nil {
//						return "", nil, nil, 0, err
//					}
//					//addr, err = btcutil.DecodeAddress(utxoTaprootAddress.EncodeAddress(), netParams)
